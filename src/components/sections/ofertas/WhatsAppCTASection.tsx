...
import { whatsappCta } from "@/data/pages/ofertas";

function WhatsAppIcon() {
  return (
    <svg
      viewBox="0 0 24 24"
      className="h-24 w-24 text-[#25D366] md:h-32 md:w-32"
      fill="currentColor"
      aria-hidden="true"
    >
...
export default function WhatsAppCTASection() {
  return (
    <section className="border-t border-brand-light bg-white py-14 md:py-16">
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        <div className="flex flex-col items-center justify-between gap-10 md:flex-row md:gap-12">
          <div className="max-w-xl text-center md:text-left">
            ...
            <h2 className="mt-3 text-2xl font-bold leading-snug text-brand-dark md:text-3xl">
              {whatsappCta.title}
            </h2>
