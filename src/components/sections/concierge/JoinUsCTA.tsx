...
import { getConciergeJoinCta } from "@/data/pages/concierge";
...
export default function JoinUsCTA() {
  ...
  const conciergeJoinCta = getConciergeJoinCta(language);
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 lg:px-6">
        <div className="rounded-3xl border border-brand-gold/30 bg-white/[0.03] p-8 md:p-14 backdrop-blur-md shadow-2xl">
          ...
          <div className="mx-auto max-w-3xl text-center">
            {conciergeJoinCta.dividerImage && (
              <div className="mx-auto mb-4 flex justify-center">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={conciergeJoinCta.dividerImage}
                  alt="BAGIA Emblem"
                  className="h-14 w-auto object-contain filter drop-shadow-[0_0_12px_rgba(201,162,39,0.5)]"
                />
              </div>
            )}
            ...
            <h2 className="mt-4 text-3xl font-extrabold text-white md:text-4xl lg:text-5xl">
              {conciergeJoinCta.title}
            </h2>

            <p className="mt-4 text-base leading-relaxed text-gray-300 md:text-lg">
              {conciergeJoinCta.paragraphs[0]}
            </p>
          </div>
